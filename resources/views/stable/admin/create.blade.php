...
@section('breadcrumbs')
    {{ Breadcrumbs::render('stable-admin-create') }}
@endsection
...
<div class="d-flex flex-row">
    ...
    <div class="flex-row-fluid ml-lg-8">
        ...
        <div class="card card-custom card-stretch">
            ...
            <!--end::Header-->
            <!--begin::Form-->
            <form class="form" method="post" name="createform" id="createform" action="{{ route('stable.admin.store') }}">
                @csrf
                <!--begin::Body-->
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                            ...
                            <a href="{{ route('stable.admin.index') }}" class="btn btn-secondary"><i class="far fa-arrow-alt-circle-left"></i> Back</a>
                        </div>
                    </div>
                </div>
                <!--end::Body-->
