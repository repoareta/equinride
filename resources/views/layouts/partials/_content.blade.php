...
<div class="d-flex flex-column-fluid">
	...
	<div class="container-fluid">
		...
		<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/dashboards/demo4","page":"index"}]/-->
		...
		<div class="row">
			<div class="col-xl-4">
				...
				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/tiles/widget-8","page":"index"}]/-->
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/tiles/widget-8","page":"index"}]/-->
			</div>
			<div class="col-xl-8">

				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/advance-tables/widget-10","page":"index"}]/-->
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/advance-tables/widget-10","page":"index"}]/-->
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xl-4">
				...
				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/lists/widget-16","page":"index"}]/-->
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/lists/widget-16","page":"index"}]/-->
			</div>
			<div class="col-xl-4">

				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-5","page":"index"}]/-->
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-5","page":"index"}]/-->
			</div>
			<div class="col-xl-4">

				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/tiles/widget-15","page":"index"}]/-->
						...
						<div class="flex-grow-1">
							...
							<div class="d-flex align-items-center justify-content-between">
								<div class="d-flex align-items-center mr-2">
									<div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
										<div class="symbol-label">
											<img src="{{ asset('assets/media/svg/misc/009-hot-air-balloon.svg') }}" alt="" class="h-50" />
										</div>
									</div>
									<div>
										<a href="#" class="font-size-h6 text-dark-75 assets/media/svg/misc/009-hot-air-balloon.svgtext-hover-primary font-weight-bolder">Top Engagement</a>
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/tiles/widget-15","page":"index"}]/-->
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xl-4">
				...
				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-10","page":"index"}]/-->
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-10","page":"index"}]/-->
			</div>
			<div class="col-xl-4">

				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-11","page":"index"}]/-->
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-11","page":"index"}]/-->
			</div>
			<div class="col-xl-4">

				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-12","page":"index"}]/-->
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-12","page":"index"}]/-->
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-lg-8">
				...
				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/base-tables/widget-2","page":"index"}]/-->
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/base-tables/widget-2","page":"index"}]/-->
			</div>
		</div>
		...
		<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/dashboards/demo4","page":"index"}]/-->
