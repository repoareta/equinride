        ...
        <div class="card card-custom card-stretch">
            ...
            <div class="card-header py-3">
                <div class="card-title align-items-start flex-column">
                    <h3 class="card-label font-weight-bolder text-dark">Edit Horse Breed</h3>
                    <span class="text-muted font-weight-bold font-size-sm mt-1">Edit your new horse breed</span>
                </div>
            </div>
            <!--end::Header-->
            <!--begin::Form-->
