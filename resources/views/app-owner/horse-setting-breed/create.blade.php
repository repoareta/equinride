...
@section('breadcrumbs')
{{ Breadcrumbs::render('owner-horse-breed-create') }}
@endsection
...
<div class="d-flex flex-row">
    ...
    <div class="flex-row-fluid ml-lg-8">
        ...
        <div class="card card-custom card-stretch">
            ...
            <!--end::Header-->
            <!--begin::Form-->
            <form class="form" name="createform" id="createform" action="{{ route('app_owner.horse.horse_breed.store') }}" method="POST">
                @csrf
                <!--begin::Body-->
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                            <input type="text" class="form-control form-control-lg form-control-solid" name="name" placeholder=" Enter Horse Breed">                            
                        </div>
                    </div>
                    <div class="row">
